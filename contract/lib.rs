...
declare_id!("6fYwmZZ6eH8Kt3ft4ULufWTojuyDmht5HpLLZbYp5AMw");
...
mod lottery {
    ...
    pub fn create_lottery(ctx: Context<CreateLottery>, _ticket_price: u64) -> Result<()> {
    ...
    pub fn buy_ticket(ctx: Context<BuyTicket>, lottery_id: u32) -> Result<()> {
        ...
        if lottery.winner_id.is_some() {
            return err!(LotteryError::WinnerAlreadyExist);
        }
